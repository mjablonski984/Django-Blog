...
# import user urls directly
# use dafault login/logout class-based views (backend only, template must be created)
# routes starting with password are default password reset urls used here with default password reset view classess 
urlpatterns = [
...
# add static media dir (only in development - whem debug=True)
if settings.DEBUG:
